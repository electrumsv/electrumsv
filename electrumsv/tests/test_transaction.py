...
class TestTransaction:
    ...
    def test_tx_unsigned(self):
        ...
        assert json.dumps(tx.to_dict(TransactionContext(), [])) == '{"version": 2, "hex": "010000000149f35e43fefd22d8bb9e4b3ff294c6286154c25712baf6ab77b646e5074d6aed010000002401ff2103b5bbebceeb33c1b61f649596b9c3611c6b2853a1f6b48bce05dd54f667fa2166feffffff0118e43201000000001976a914e158fb15c888037fdc40fb9133b4c1c3c688706488ac5fbd0700", "complete": false, "inputs": [{"script_type": 2, "threshold": 1, "value": 20112600, "signatures": ["ff"], "x_pubkeys": [{"bip32_xpub": "xpub661MyMwAqRbcFL6WFqND2XM2w1EfpBwFfhsSUcw9xDR3nH8eYLv4z4HAhxv5zkqjHojWsPYK1ZSK7yCr8fZ9iWU6D361G2ryv5UgsKjbeDq", "derivation_path": [0, 35]}]}]}'
    ...
    def test_tx_signed(self):
        ...
        assert tx.locktime == 507231
        assert tx.to_dict(TransactionContext(), []) == {'hex': signed_blob, 'complete': True, 'version': 2}
...
class TestTransaction2:
    ...
    def test_sign_tx_1(self):
        ...
        assert json.dumps(tx.to_dict(TransactionContext(), [])) == '{"version": 2, "hex": "", "complete": false, "inputs": [{"script_type": 2, "threshold": 1, "value": 18161, "signatures": ["ff"], "x_pubkeys": [{"pubkey_bytes": "02faf7f10ccad1bc40e697e6b90b1d7c9daf92fdf47a4cf726f1c0422e4730fe85"}]}, {"script_type": 2, "threshold": 1, "value": 88385, "signatures": ["3045022100fa8ebdc7cefc407fd1b560fb2e2e5e96e900e94634d96df4fd284126048746a2022028d91ca132a1a386a67df69a2c5ba216218870c256c163d729f1575f7a8824f541"], "x_pubkeys": [{"pubkey_bytes": "030c4ee92cd3c174e9aabcdec56ddc6b6d09a7767b563055a10e5406ec48f477ea"}]}]}'
    ...
    def test_sign_tx_2(self):
        ...
        assert json.dumps(tx.to_dict(TransactionContext(), [])) == '{"version": 2, "hex": "", "complete": false, "inputs": [{"script_type": 2, "threshold": 1, "value": 18161, "signatures": ["30450221008dc02fa531a9a704f5c01abdeb58930514651565b42abf94f6ad1565d0ad6785022027b1396f772c696629a4a09b01aed2416861aeaee05d0ff4a2e6fdfde73ec84d41"], "x_pubkeys": [{"pubkey_bytes": "02faf7f10ccad1bc40e697e6b90b1d7c9daf92fdf47a4cf726f1c0422e4730fe85"}]}, {"script_type": 2, "threshold": 1, "value": 88385, "signatures": ["ff"], "x_pubkeys": [{"pubkey_bytes": "030c4ee92cd3c174e9aabcdec56ddc6b6d09a7767b563055a10e5406ec48f477ea"}]}]}'
        assert not tx.is_complete()
    ...
    unsigned_json_1 = '{"version": 2, "hex": "", "complete": false, "inputs": [{"script_type": 4, "threshold": 2, "value": 5300, "signatures": ["ff", "ff"], "x_pubkeys": [{"bip32_xpub": "xpub661MyMwAqRbcH1RHYeZc1zgwYLJ1dNozE8npCe81pnNYtN6e5KsF6cmt17Fv8wGvJrRiv6Kewm8ggBG6N3XajhoioH3stUmLRi53tk46CiA", "derivation_path": [0, 0]}, {"old_mpk": "84717a26df3332b129e59faaab25c11752277bc55c07d8724e1660e63b862d00b41d3db01e29ed54ca83300eb73d82b5381536298f40fdad8c1e307b66cf39a9", "derivation_path": [0, 0]}]}]}'
    signed1_json_1 = '{"version": 2, "hex": "", "complete": false, "inputs": [{"script_type": 4, "threshold": 2, "value": 5300, "signatures": ["ff", "3044022100a9b906ec7fd40b8063326675d5f229d36227241dc84f262b203b3eaadfd91789021f267473437145d77c69273ffef2426055c6c89457832c3d38fcb3c07eb8c39141"], "x_pubkeys": [{"bip32_xpub": "xpub661MyMwAqRbcH1RHYeZc1zgwYLJ1dNozE8npCe81pnNYtN6e5KsF6cmt17Fv8wGvJrRiv6Kewm8ggBG6N3XajhoioH3stUmLRi53tk46CiA", "derivation_path": [0, 0]}, {"old_mpk": "84717a26df3332b129e59faaab25c11752277bc55c07d8724e1660e63b862d00b41d3db01e29ed54ca83300eb73d82b5381536298f40fdad8c1e307b66cf39a9", "derivation_path": [0, 0]}]}]}'
    signed2_json_1 = '{"version": 2, "hex": "", "complete": false, "inputs": [{"script_type": 4, "threshold": 2, "value": 5300, "signatures": ["3045022100bc32a5f10b755dcd8dc9a498d76286f059993d1d72fbc5340d0da9dc99dcad0a022064e37760d9ad3e3b9f0b48263becca8dee5aac43bdcecfdfdc63553057083a8c41", "ff"], "x_pubkeys": [{"bip32_xpub": "xpub661MyMwAqRbcH1RHYeZc1zgwYLJ1dNozE8npCe81pnNYtN6e5KsF6cmt17Fv8wGvJrRiv6Kewm8ggBG6N3XajhoioH3stUmLRi53tk46CiA", "derivation_path": [0, 0]}, {"old_mpk": "84717a26df3332b129e59faaab25c11752277bc55c07d8724e1660e63b862d00b41d3db01e29ed54ca83300eb73d82b5381536298f40fdad8c1e307b66cf39a9", "derivation_path": [0, 0]}]}]}'
    ...
    unsigned_json_2 = '{"version": 2, "hex": "", "complete": false, "inputs": [{"script_type": 4, "threshold": 2, "value": 5300, "signatures": ["ff", "ff"], "x_pubkeys": [{"old_mpk": "84717a26df3332b129e59faaab25c11752277bc55c07d8724e1660e63b862d00b41d3db01e29ed54ca83300eb73d82b5381536298f40fdad8c1e307b66cf39a9", "derivation_path": [0, 0]}, {"bip32_xpub": "xpub661MyMwAqRbcH1RHYeZc1zgwYLJ1dNozE8npCe81pnNYtN6e5KsF6cmt17Fv8wGvJrRiv6Kewm8ggBG6N3XajhoioH3stUmLRi53tk46CiA", "derivation_path": [0, 0]}]}]}'
    signed1_json_2 = '{"version": 2, "hex": "", "complete": false, "inputs": [{"script_type": 4, "threshold": 2, "value": 5300, "signatures": ["304402207a923d1b0ca9930cfb2162f1e85dc5feb6e9322efcceeaba7a91ad37f72b815702207ed90ebab7c8bbf728d29c2d93931bb44ff1a7147b37982c1d27c822c139079e41", "ff"], "x_pubkeys": [{"old_mpk": "84717a26df3332b129e59faaab25c11752277bc55c07d8724e1660e63b862d00b41d3db01e29ed54ca83300eb73d82b5381536298f40fdad8c1e307b66cf39a9", "derivation_path": [0, 0]}, {"bip32_xpub": "xpub661MyMwAqRbcH1RHYeZc1zgwYLJ1dNozE8npCe81pnNYtN6e5KsF6cmt17Fv8wGvJrRiv6Kewm8ggBG6N3XajhoioH3stUmLRi53tk46CiA", "derivation_path": [0, 0]}]}]}'
    signed2_json_2 = '{"version": 2, "hex": "", "complete": false, "inputs": [{"script_type": 4, "threshold": 2, "value": 5300, "signatures": ["ff", "3045022100ae42f172f722ac2392ef3e5958d78bbca1ebedbce47eff27ba66345be781c46f02207c9ab6ff496791bf2e56300ff4621beaec6ccdd3639e460612569c6e0407e09a41"], "x_pubkeys": [{"old_mpk": "84717a26df3332b129e59faaab25c11752277bc55c07d8724e1660e63b862d00b41d3db01e29ed54ca83300eb73d82b5381536298f40fdad8c1e307b66cf39a9", "derivation_path": [0, 0]}, {"bip32_xpub": "xpub661MyMwAqRbcH1RHYeZc1zgwYLJ1dNozE8npCe81pnNYtN6e5KsF6cmt17Fv8wGvJrRiv6Kewm8ggBG6N3XajhoioH3stUmLRi53tk46CiA", "derivation_path": [0, 0]}]}]}'
