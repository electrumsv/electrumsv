...
;General
  ...
  ;Name and file
  Name "${PRODUCT_NAME}"
  OutFile "dist/ElectrumSV-setup.exe"
...
;Interface Settings
  ...
  !define MUI_ICON "c:\electrum\electrumsv\data\icons\electrum-sv.ico"
...
Section
  ...
  File "c:\electrum\electrumsv\data\icons\electrum-sv.ico"
  ...
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\ElectrumSV-${PRODUCT_VERSION}.exe" ""
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\electrum-sv.ico"
