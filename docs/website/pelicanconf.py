...
DOWNLOAD_LATEST = DownloadEntry("1.3.15", "2022/06/17", "/articles/2022/electrumsv-1_3_15.html", [
    DownloadFileEntry("fab fa-apple", "MacOS downloads", "MacOS", "ElectrumSV-1.3.15.dmg","30.7 MiB"),
    ...
    DownloadFileEntry("fas fa-code", "Other downloads", "Source code", "ElectrumSV-1.3.15.tar.gz", "9.3 MiB"),
    DownloadFileEntry("fas fa-code", "Other downloads", "Source code", "ElectrumSV-1.3.15.zip", "9.6 MiB"),
